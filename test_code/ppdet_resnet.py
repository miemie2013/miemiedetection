...
from .ppdet_name_adapter import NameAdapter
...
def load_weight(model, param_path):
    param_state_dict = paddle.load(param_path)
    ...
    #                                                        incorrect_keys)
    print('Finish resuming model weights: {}'.format(param_path))
