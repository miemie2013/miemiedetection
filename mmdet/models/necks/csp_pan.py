...
from mmdet.models.initializer import kaiming_uniform_
...
class DPModule(nn.Module):
    ...
    def __init__(self,
        ...
        self.dwconv = nn.Conv2d(
            ...
            stride=stride,
            bias=False)
        kaiming_uniform_(self.dwconv.weight)
        ...
        self.pwconv = nn.Conv2d(
            ...
            padding=0,
            bias=False)
        kaiming_uniform_(self.pwconv.weight)
...
class Channel_T(nn.Module):
    def __init__(self,
        ...
        for i in range(len(in_channels)):
            conv_layer = ConvBNLayer(in_channels[i], out_channels, 1, act=act)
