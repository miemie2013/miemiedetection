...
* 【2022/05/15】 加入了PPYOLOE算法(基于PaddleDetection-release-2.4版本的代码复现)！实测可以复现官方的精度！命令请参考[PPYOLOE](docs/README_PPYOLO.md#训练COCO数据集) 文档的“训练COCO数据集”小节。训练日志见train_coco/ppyoloe_s_8gpu.txt
